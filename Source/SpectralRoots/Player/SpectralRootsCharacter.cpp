...
ASpectralRootsCharacter::ASpectralRootsCharacter()
{
...
void ASpectralRootsCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ASpectralRootsCharacter::Move);
...
void ASpectralRootsCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
